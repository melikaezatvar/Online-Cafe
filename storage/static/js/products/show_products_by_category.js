            ...
            data.forEach(category => {
                if (category.get_childes.length === 0 && category.get_products.length !== 0) {
                    ...
                    category.get_products.forEach(product => {
                        ...
                        <a href="/api/product/${product.id}" class="row product" style="">
                        ...
                        if (product.images.length) {
                            ...
                            <img class="rounded-circle mb-3 mb-sm-0 " src="${product.images[0].src}" alt="${product.images[0].alt}" style="max-width: 100%;
    height: auto;">`
                        } else {
                            menuEl.querySelector('#p-'+product.id).innerHTML += `
                            <img class="rounded-circle mb-3 mb-sm-0" src="/media/product/images/site_image.jpeg" alt="no-image-available">`
                        }
                    })
                }
            })
